...
def get_response(instructions, previous_questions_and_answers, new_question):
    ...
    """
    # build the messages
    new_question = translator.translate(new_question, src="fa", dest="en").text
...
def generate_response(prompt):
    completion=openai.Completion.create(
        model="gpt-3.5-turbo",
        prompt=translator.translate(prompt, src="fa", dest="en").text,
        max_tokens=1024,
        n=1,
        stop=None,
        temperature=0.5,
    ...
    return translator.translate(message, src="en", dest="fa").text


previous_questions_and_answers = []
    
st.title("یه سوال بپرس جواب میدم")
#storing the chat
